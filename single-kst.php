...
<main class="kst-detail-page">
    <!-- HERO HEADER -->
    <section class="kst-detail-hero" style="background: linear-gradient(rgba(17, 24, 39, 0.75), rgba(17, 24, 39, 0.75)), url('<?php echo esc_url($kst_image); ?>') center/cover;">
        <div class="container">
                ...
                <div class="kst-detail-sidebar">
                    ...
                    <div class="kst-sidebar-card card-action">
                        ...
                        <div class="sidebar-action-buttons">
                            <a href="<?php echo esc_url($landing_page_url); ?>" class="btn-kst-sidebar-action btn-landing" target="_blank">
                                ...
                                <?php if ($kontak_telepon) : ?>
                                    <li>
                                        ...
                                        <div class="contact-text">
                                            ...
                                            <p><a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', $kontak_telepon)); ?>"><?php echo esc_html($kontak_telepon); ?></a></p>
                                        </div>
                                    </li>
                                <?php endif; ?>
                                <?php if ($kontak_email) : ?>
                                    <li>
                                        ...
                                        <div class="contact-text">
                                            <strong>Email:</strong>
                                            <p><a href="mailto:<?php echo esc_attr($kontak_email); ?>"><?php echo esc_html($kontak_email); ?></a></p>
                                        </div>
                                    </li>
                                <?php endif; ?>
                            </ul>
        ...
        <div class="kst-modal-container">
            ...
            <div class="kst-modal-body">
                <div class="kst-website-info">
                    ...
                    <p class="info-text">
                        <strong>Pemberitahuan:</strong> Halaman Dashboard hanya dapat diakses oleh pengguna yang memiliki akun resmi. Jika Anda sudah memiliki akun, silakan lanjut ke dashboard.
                    </p>
                </div>

                <div class="kst-website-buttons">
                    <a href="<?php echo esc_url($dashboard_url); ?>" class="btn-kst-action btn-landing" style="background-color: var(--green); border-color: var(--green);" target="_blank">
