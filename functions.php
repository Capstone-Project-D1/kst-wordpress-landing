  ...
  acf_add_local_field_group(
    array(
      ...
      'fields' => array(
        ...
        array(
          'key' => 'field_kst_ub_kst_landing_page_url',
          'label' => 'Landing Page URL',
          'name' => 'kst_landing_page_url',
          'type' => 'url',
          'instructions' => 'Masukkan URL untuk Landing Page kawasan ini.',
        ),
        array(
          'key' => 'field_kst_ub_kst_dashboard_url',
          'label' => 'Dashboard URL',
          'name' => 'kst_dashboard_url',
          'type' => 'url',
          'instructions' => 'Masukkan URL untuk Dashboard kawasan ini.',
        ),
        array(
          'key' => 'field_kst_ub_kst_kontak_email',
          'label' => 'Kontak Email',
          'name' => 'kst_kontak_email',
          'type' => 'email',
          'instructions' => 'Masukkan email kontak resmi kawasan ini.',
        ),
        array(
          'key' => 'field_kst_ub_kst_kontak_telepon',
          'label' => 'Kontak Telepon',
          'name' => 'kst_kontak_telepon',
          'type' => 'text',
          'instructions' => 'Masukkan nomor telepon/WhatsApp resmi kawasan ini.',
        ),
        array(
          'key' => 'field_kst_ub_kst_alamat_lengkap',
          'label' => 'Alamat Lengkap',
          'name' => 'kst_alamat_lengkap',
          'type' => 'textarea',
          'rows' => 3,
          'instructions' => 'Masukkan alamat fisik lengkap kawasan ini.',
        ),
        array(
          'key' => 'field_kst_ub_kst_map_embed',
          'label' => 'Google Maps Embed (Iframe)',
          'name' => 'kst_map_embed',
          'type' => 'textarea',
          'rows' => 4,
          'instructions' => 'Masukkan kode iframe Google Maps embed.',
        ),
      ),
      'location' => array(
        array(
